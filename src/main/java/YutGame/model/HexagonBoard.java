 ...
 */
public final class HexagonBoard implements Board {

    public static final int FINISH = 44;
    private static final int END = 30; // 도착 노드 id
